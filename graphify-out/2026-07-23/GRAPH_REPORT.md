# Graph Report - stellog-demo  (2026-07-22)

## Corpus Check
- 21 files · ~23,760 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 144 nodes · 125 edges · 28 communities (11 shown, 17 thin omitted)
...
Cohesion: 0.06
Nodes (35): eslint, eslint-config-prettier, @eslint/js, eslint-plugin-svelte, devDependencies, eslint, eslint-config-prettier, @eslint/js (+27 more)
...
## Knowledge Gaps
- **90 isolated node(s):** `@types/express`, `express`, `app`, `target`, `module` (+85 more)
