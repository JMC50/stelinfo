        ...
        page.on("response", (response) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (url.includes(`/channels/${channelId}/live-detail`)) {
                    captured.liveDetail = yield response.json();
                }
                else if (url.includes(`/channels/${channelId}/videos`)) {
                    (_a = captured.videos) !== null && _a !== void 0 ? _a : (captured.videos = yield response.json());
                }
            }
            catch (_b) {
...
const cache = new Map();
function getLatestBroadcast(stellarId) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
        ...
        if (cached && cached.expiresAt > Date.now())
            return cached.data;
        const { liveDetail, videos } = yield captureChannelPage(channelId);
        let result = null;
        const live = liveDetail === null || liveDetail === void 0 ? void 0 : liveDetail.content;
        if ((live === null || live === void 0 ? void 0 : live.status) === "OPEN") {
            result = {
            ...
            const latestVideo = (_b = (_a = videos === null || videos === void 0 ? void 0 : videos.content) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b[0];
            if (latestVideo) {
                result = {
